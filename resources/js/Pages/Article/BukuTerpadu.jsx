...
export default function BukuTerpadu() {
    ...
    const canvasSize = useMemo(() => {
        ...
        if (windowWidth < 1024)
            return { width: "100%", height: "40vh", posX: -0.05 };
    ...
    return (
        <>
            <section
                ref={sectionRef}
                className="w-full min-h-[100vh] bg-gradient-to-b from-[#FCFFEC] via-[#C4E196] to-[#90C444] flex flex-col items-center justify-start gap-6 py-12 relative overflow-visible px-4 md:px-16"
            >
                ...
                <div className="relative w-full max-w-6xl bg-white shadow-xl rounded-2xl p-12 md:p-16 border border-[#D8EBC5] z-10 text-center -mt-20 md:-mt-28">
