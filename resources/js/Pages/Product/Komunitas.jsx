...
export default function KomuIntro() {
  ...
  return (
    <>
      {/* Bagian Komunitas */}
      <section className="min-h-screen flex flex-col items-center justify-center w-full px-6 pt-16 pb-12 relative bg-[#FEFFF5]">
        {/* Judul */}
        <h1
        ...
        <div
          className={`bg-[#F0FCD7] rounded-3xl shadow-2xl border-2 border-green-200 p-12 md:p-16 flex flex-col md:flex-row items-center gap-14 max-w-5xl transition-all duration-700 ease-out ${
            animateText ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-90"
          }`}
        >
          {/* Teks */}
          <p
          ...
          <div className="relative group">
            <img
              ...
              className={`w-56 md:w-full drop-shadow-2xl transition-all duration-700 ease-out ${
                animateImage ? "opacity-100 scale-100 rotate-0 animate-float" : "opacity-0 scale-0 -rotate-12"
