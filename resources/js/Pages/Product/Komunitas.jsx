        ...
        <>
            ...
            <section className="min-h-screen flex flex-col items-center justify-center w-full px-6 pt-16 pb-12 relative bg-[#FCFFEC] overflow-hidden">
                ...
                >
                    ...
                    <span className="text-green-400">komunitas</span>
                </h1>
                ...
                >
                    ...
                    <span className="text-green-600 font-bold">seminar</span>{" "}
                    produk-produk tanaman dan forum{" "}
                    <span className="text-green-600 font-bold">komunitas</span>{" "}
                    Nutriverse.{" "}
                    sebagai tempat diskusi antarsiswa.
                </p>
