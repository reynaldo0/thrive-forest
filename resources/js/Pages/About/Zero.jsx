...
export default function ZeroHunger() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-[#fafbe9] via-[#ffe7b3] to-[#f5c16c] py-16 px-6 font-sans relative overflow-hidden">
      {/* Background hand tunggal */}
      <div className="absolute bottom-0 left-0 right-0 flex justify-center items-end opacity-90 z-0">
        <img
          src="/background/bg-tangan.png"
          alt="hand"
          className="w-full max-w-[10000px]"
        /> 
      </div>
      {/* animate-bounce-slow */}
