...
export default function TeamNutriverse() {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center w-full px-6 py-20 relative bg-gradient-to-b from-[#fdfdf7] via-[#f4faec] to-[#e5f8e3] overflow-hidden">
      {/* Judul */}
      <h2
